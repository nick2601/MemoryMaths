...
class RateViewDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final double starSize = FetchPixels.getPixelHeight(80);
        ...
        return Column(
          ...
          children: [
            ...
            getTextWidget(
              ...
              "Make better math goals for you. We’d love to know how you would rate our app!",
              TextAlign.center,
              ...
              children: [
                Expanded(
                  child: getButtonWidget(
                    ...
                    textColor: darken(KeyUtil.primaryColor1)
                  ),
                ),
                ...
                Expanded(
                  child: getButtonWidget(
                    context,
                    "Submit",
                    darken(colorTuple.item1.primaryColor!),
                        () {
                      if (rate >= 3) {
                        Navigator.of(context).pop();
